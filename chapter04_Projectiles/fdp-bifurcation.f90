...
program dlo_solve
 ...
 NtPI = 50; !how many intervals in the interval [t,t+PI]
 NPIs = 500 !total time is NPIs*PI
 Nt   = NtPI*NPIs+1
 PI   = atan2(0.0D0,-1.0D0); 
 Ti   = 0.0D0; Tf = Ti+NPIs*PI; Ntrans   = Nt-10000;
 ...
 open(unit=11,file='fdp-bifurcation.dat')
 a_0 = 0.20D0; da0 = 0.002D0;!0.02D0;
 do while( a_0 < 5.0D0)
